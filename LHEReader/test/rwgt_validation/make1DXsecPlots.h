...
void make_1d_xsec_plot(
    ...
    //plt_ops.x_min = -10.0;
    //plt_ops.x_max = 10.0;
    //if (wc_name != "cpt" and wc_name != "ctG"){
    //if (wc_name != "ctp" and wc_name != "ctG"){
    //if (wc_name != "ctp"){
        //plt_ops.y_min = 0.5;
        //plt_ops.y_min = y_axis_min;
    //} else if (wc_name == "ctG" ){
        //plt_ops.y_min = 0.8;
    //}
    //plt_ops.y_max = 1.2;
    ...
    //TCanvas *c1 = new TCanvas("c1","",1020,1000);
    ...
    for (uint i = 0; i < wc_fits.size(); i++) {
        ...
        if (tmp_max_nlo_pt*1.5 > fit->GetMaximum()){
